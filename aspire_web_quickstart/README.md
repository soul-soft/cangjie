...
| 模块名称                                    | 描述                          | 必要性  | 链接                                                                 |
|--------------------------------------------|------------------------------|--------|----------------------------------------------------------------------|
| aspire_web_http                          | HTTP核心功能                  | 必需    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_http.git)           |
| aspire_web_mvc                           | MVC                          | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_mvc.git)        |
| aspire_web_routing                       | 路由与终结点                | 必需    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_routing.git)        |
| aspire_web_hosting                       | Web主机                       | 必需    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_hosting.git)        |
| aspire_web_staticfiles                   | 静态文件支持                  | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_staticfiles.git)    |
| aspire_web_healthchecks                  | 健康检查中间件                | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_healthchecks.git)   |
| aspire_web_authentication                  | 身份认证中间件              | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_authentication.git)   |
| aspire_web_authorization                  | 授权中间件                | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_web_authorization.git)   |
| aspire_identity_claims                | 身份声明                  | 可选     | [链接](https://github.com/soul-soft/aspire_web/aspire_identity_claims.git) |
| aspire_extensions_hosting                | 通用主机                    | 可选     | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_hosting.git) |
| aspire_extensions_logging                | 日志                      | 可选     | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_logging.git) |
| aspire_extensions_options                | 选项                      | 必需    | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_options.git) |
| aspire_extensions_injection              | 依赖注入                      | 可选     | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_injection.git) |
| aspire_extensions_healthchecks           | 健康检查服务                  | 可选    | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_healthchecks.git) |
| aspire_extensions_configuration          | 配置管理                      | 可选     | [链接](https://github.com/soul-soft/aspire_web/aspire_extensions_configuration.git) |
